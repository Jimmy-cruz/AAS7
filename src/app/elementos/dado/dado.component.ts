...
export class DadoComponent {
  ...
  // declaramos una variable que almacene el ultimo resultado obtenido
  resultadoAnterior:number = this.resultado;
  ...
  lanzar(){
    ...
    // asignamos el ultimo resultado obtenido a la variable para imprimirlo en la vista
